...
(async()=>{
    ...
    try{
        ...
        await click(partyToggle+' .fury-binary-off');await waitSaved('partySplitWarningsEnabled',false);
        await page.evaluate('refresh()');assert.strictEqual(await page.$eval('#party-split-warnings-enabled',el=>el.checked),false);
        await click(partyToggle+' .fury-binary-on');await waitSaved('partySplitWarningsEnabled',true);
        await click(partyToggle+' .fury-binary-off');await waitSaved('partySplitWarningsEnabled',false);
